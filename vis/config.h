...
static const KeyBinding bindings_normal[] = {
	...
	{ "<M-w>c",             ALIAS(":q<Enter>")                          },
	{ "<M-w>h",             ALIAS("<M-w>k")                             },
	{ "<M-w>j",             ACTION(WINDOW_NEXT)                         },
	{ "<M-w>k",             ACTION(WINDOW_PREV)                         },
	{ "<M-w>l",             ALIAS("<M-w>j")                             },
	{ "<M-w>n",             ALIAS(":open<Enter>")                       },
	{ "<M-w>s",             ALIAS(":split<Enter>")                      },
	{ "<M-w>v",             ALIAS(":vsplit<Enter>")                     },
...
static const KeyBinding bindings_visual[] = {
	...
	{ "<C-k>",              ALIAS("<C-u>")                              },
	{ "<C-l>",              ACTION(SELECTIONS_REMOVE_COLUMN_EXCEPT)     },
	{ "<M-n>",              ACTION(SELECTIONS_NEW_MATCH_NEXT)           },
	{ "<C-p>",              ACTION(SELECTIONS_REMOVE_LAST)              },
	{ "<C-u>",              ACTION(SELECTIONS_PREV)                     },
...
static const KeyBinding bindings_insert[] = {
	...
	{ "<M-t>",              ALIAS("<vis-operator-shift-right><vis-operator-shift-right>") },
