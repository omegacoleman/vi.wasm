...
LIBCDIR = ../libc
CFLAGS = --target=wasm32 -isystem $(LIBCDIR)/include -funsigned-char -std=gnu99 -fno-builtin -nodefaultlibs -nostdlib -DNDEBUG -MMD -Wno-deprecated-non-prototype -U_XOPEN_SOURCE -D_XOPEN_SOURCE=700
